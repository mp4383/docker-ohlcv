...
WEBSOCKET_URL = 'wss://fstream.binance.com/ws/solusdt@aggTrade'
OHLCV_FILENAME = 'solana_1s_ohlcv.csv'
    ...
    while True:
        try:
            async with connect(WEBSOCKET_URL) as websocket:
                print(f"Connected to Binance WebSocket feed for SOL-USDT")
...
async def main():
    print(f"Starting Solana 1-second OHLCV data collection...")
